...
public class CampaignSummaryResponse {
    ...
    public static CampaignSummaryResponse fromEntity(Campaign campaign, String imageUrl) {
        ...
        Boolean isCancel =
                campaign.getState() == State.RECRUITING
                        || campaign.getState() == State.RECRUITMENT_COMPLETED
                        || campaign.getState() == State.EXPERIENCE_AND_REVIEW;
        ...
        return CampaignSummaryResponse.builder()
                ...
                .status(campaign.getState().getDisplayName())
