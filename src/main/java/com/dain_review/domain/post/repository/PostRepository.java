...
public interface PostRepository extends JpaRepository<Post, Long> {
    ...
    @Query(
            "SELECT p FROM Post p JOIN FETCH p.postMeta WHERE p.categoryType = :categoryType AND p.communityType = :communityType AND p.deleted = false ORDER BY p.createdAt DESC")
